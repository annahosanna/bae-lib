...
class TestFASCNSubjectIdentifier extends AbstractTest {


    @Test
    public void testValidFASCN1() {
    ...
    static String FASCN_CERT_FILE_NAME = "fascn-cert-card1.crt"
    ...
    static String FASCN_CERT_FILE2_NAME = "piv2.crt"
    ...
    public void testHasFASCNFromCertificate2() throws Exception {
        ...
        logger.debug("Reading cert...")
        File certFile = getCertFile(FASCN_CERT_FILE2_NAME);
        X509CertificateObject cert = readCert(certFile);
    ...
    static String FASCN_CERT_FILE3_NAME = "piv3.crt"
    ...
    static String FASCN_CERT_FILE4_NAME = "piv4.crt"
    ...
    static String FASCN_CERT_FILE5_NAME = "piv5.crt"
